...
class AutomatorWP_Tutor_LMS_Complete_Quiz extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User attempts a quiz', 'automatorwp-tutor-integration' ),
            'select_option'     => __( 'User <strong>attempts</strong> a quiz', 'automatorwp-tutor-integration' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User attempts %1$s %2$s time(s)', 'automatorwp-tutor-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User attempts %1$s', 'automatorwp-tutor-integration' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Quiz:', 'automatorwp-tutor-integration' ),
                    'option_none_label' => __( 'any quiz', 'automatorwp-tutor-integration' ),
